...
single.seg <- pcf(data=combined.win,gamma=1,verbose=F, fast=FALSE)
...
```
```{r}
plotFreq(segments=single.seg,thres.gain=0.2,thres.loss=-0.1, main="JFCF ALT Frequency")
...
```{r}
plotFreq(segments=single.seg,thres.gain=0.2,thres.loss=-0.1, main="JFCF TEL Frequency")
